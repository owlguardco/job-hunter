...
const stages = [
  {
    ...
    steps: [
      ...
      { cmd: 'npm run decode',  desc: 'Decode a JD — red flags, real pay, what they actually want' },
    ...
    tip: 'Start with `npm run jobs`. Fill in inputs/job-search-criteria.md first — role titles, location, filters.',
    next: 'apply',
  },
  {
    id: 'apply',
    ...
    steps: [
      { cmd: 'npm run decode',        desc: 'Understand the JD before doing anything else' },
      ...
      { cmd: 'npm run linkedin',      desc: 'Audit your LinkedIn profile against the role' },
    ],
    tip: 'Run in this order: decode → ats → resume → cover-letter. Don\'t skip decode — it tells you what you\'re actually applying for.',
    next: 'interview',
  },
  {
    id: 'interview',
